...
class Lexer
  ...
  def nextToken()
    if @c == "eof"
      ...
      nextCh()
      return Token.new(Token::IF, "if")

    elsif @c == "then"
      nextCh()
      return Token.new(Token::THEN, "then")

    elsif @c == "while"
      nextCh()
      return Token.new(Token::WHILE, "while")
      ...
      while letter?(@c) and str.length < 5
        str += @c
        nextCh()
      end
      ...
      if str == "print"
        ...
        return Token.new(Token::UNKWN, str)
      end
    else
